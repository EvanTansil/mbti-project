...
let theCamp = new Personality("ENFP", "The Campaigner", `A Campaigner (ENFP) is someone with the , Extroverted, Intuitive, Feeling, and Prospecting personality traits. These people tend to embrace big ideas and actions that reflect their sense of hope and goodwill toward others. Their vibrant energy can flow in many directions.
...
let theEnter = new Personality("ESFP", "The Entertainer", `An Entertainer (ESFP) is a person with the Extraverted, Sensing, Feeling, and Prospecting personality traits. These people love vibrant experiences, engaging in life eagerly and taking pleasure in discovering the unknown. They can be very social, often encouraging others into shared activities.
